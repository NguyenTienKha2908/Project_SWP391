...
public class UsersController {
    ...
    public String showFormForUpdateCustomer(@PathVariable("id") int id, Model model) {
        ...
        return "Users/update_customer";
    }

    @PostMapping("/users/updateCustomer/{id}")
    public String updateCustomer(@PathVariable("id") int id, @ModelAttribute("user") @Valid Users user,
    ...
    public String showFormForUpdateStaff(@PathVariable("id") int id, Model model) {
        Users user = usersService.getUsersById(id);
        model.addAttribute("user", user);
        return "Users/update_staff";
    }

    @PostMapping("/users/updateStaff/{id}")
    public String updateStaff(@PathVariable("id") int id, @ModelAttribute("user") @Valid Users user,
                              BindingResult result, RedirectAttributes redirectAttributes) {
        if (result.hasErrors()) {
            return "Users/update_staff";
        }
