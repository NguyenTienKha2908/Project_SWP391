...
public class ManagerDashboardController {
    ...
    public String showDashboard(Model model) {
        ...
        // Fetch percentage change in revenue compared to the previous month
        double revenueChangePercentage = productionOrderService.getRevenueChangePercentage();
        ...
        return "employee/manager/manager-dashboard";
    }
}
