...
public class CustomerViewController {
    ...
    public String saveCustomerMaterial(
        ...
        int selectedMaterialId = Integer.parseInt(requestParams.get("selectedMaterialId"));
        int selectedMaterialWeight = Integer.parseInt(requestParams.get("selectedMaterialWeight"));
    ...
    public ResponseEntity<List<DiamondResponse>> saveDiamondRange(
        ...
        // BigDecimal formattedMinWeight = BigDecimal.valueOf(minWeight).setScale(2,
        // RoundingMode.HALF_UP);
        // BigDecimal formattedMaxWeight = BigDecimal.valueOf(maxWeight).setScale(2,
        // RoundingMode.HALF_UP);
    ...
    // productDesignService.findByProductId(productId);
    // if (productDesign == null) {
    ...
    // productMaterialService.getProductMaterialByProduct_id(productId);
    ...
    // productionOrder.setDescription("Default Description");
    ...
    // + productionOrder.getQ_Material_Amount() +
    // productionOrder.getQ_Production_Amount());
    ...
    // + 100);
    // productionOrder.setO_Total_Amount(productionOrder.getQ_Material_Amount() +
    // 300);
    ...
    // productionOrder.setSales_Staff("SS004");
    // productionOrder.setDesign_Staff("DE004");
    // productionOrder.setProduction_Staff("PR004");

    // productionOrderService.saveProductionOrder(productionOrder);

    // redirectAttributes.addAttribute("productId", productId);
    // redirectAttributes.addAttribute("orderId",
    ...
    // String diamondUrl =
    // imageService.getImgByDiamondID(String.valueOf(selectedDiamond.getDia_Id()));

    // redirectAttributes.addAttribute("diamondId", selectedDiamond.getDia_Id());
    // redirectAttributes.addAttribute("materialId",
    // productMaterial.getId().getMaterial_Id());
    ...
    public String saveFinalNote(
        ...
        String materialUrl = imageService
                .getImgByMaterialID(String.valueOf(productMaterial.getId().getMaterial_Id()));
        String diamondUrl = imageService.getImgByDiamondID(String.valueOf(diamondId));

        redirectAttributes.addAttribute("productId", productId);
        redirectAttributes.addAttribute("orderId", orderId);
        redirectAttributes.addAttribute("diamondId", diamondId);
        redirectAttributes.addAttribute("cateUrl", cateUrl);
        redirectAttributes.addAttribute("materialUrl", materialUrl);
        redirectAttributes.addAttribute("diamondUrl", diamondUrl);
