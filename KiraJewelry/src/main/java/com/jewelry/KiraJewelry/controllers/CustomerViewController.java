...
@Controller
@SessionAttributes({ "productId", "categoryId", "materialId" })
public class CustomerViewController {
    ...
    public String customizeJewelry(Model model, HttpSession session) {
        ...
        // Create a new ProductionOrder if none exists
    ...
    // materialPriceListService.findTopByMaterialId(selectedMaterialId);
    // float price = 0;
    ...
    // // Product_Material_Id will be auto-generated
    // productMaterialService.saveProductMaterial(newProductMaterial);
    // }

    // ProductDesignShell productDesignShell =
    // productDesignShellService.findByMaterialIdAndWeight(selectedMaterialId,
    ...
    public String saveCustomerMaterial(@RequestParam("productId") int productId,
        ...
        // Fetch existing ProductMaterial by Product_Id and Material_Id
        ProductMaterial existingProductMaterial = productMaterialService.findByProductId(productId);
