...
public class OrderController {
    ...
    public String userOrders(@RequestParam("customerName") String customerName, Model model) {
        ...
        List<ProductionOrder> requestedOrders2 = productionOrderService.getProductionOrderByStatus("Ordered(WP)");
        ...
        allOrders.addAll(createdOrders);
        allOrders.addAll(requestedOrders);
        allOrders.addAll(requestedOrders2);
    ...
    public String userQuotes(@RequestParam("customerName") String customerName, Model model) {
        Customer customer = customerService.getCustomerIdByCustomerName(customerName);
        String customerId = customer.getCustomer_Id();

        List<ProductionOrder> createdOrders = productionOrderService.getProductionOrderByStatus("Quoted(WC)");
        List<ProductionOrder> requestedOrders = productionOrderService.getProductionOrderByStatus("Quoted(CNP)");
