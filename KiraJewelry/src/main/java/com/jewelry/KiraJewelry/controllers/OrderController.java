...
public class OrderController {
    ...
    //                 && (porder.getStatus().equalsIgnoreCase("Created")
    ...
    //                 .getEmployeeById(newestProductionOrder.getSales_Staff().getEmployee_Id());
    //         if (employee == null) {
    ...
    //         }
    //         try {
    //             imagesByCustomerId = imageService.getImgByCustomerID(customerId,
    //                     newestProductionOrder.getProduction_Order_Id());
    ...
    //         String catergoryName = categoryService
    //                 .getCateNameById(newestProductionOrder.getCategory().getCategory_Id());
    ...
    public String userViewOrder(@RequestParam("customerName") String customerName, Model model) {
        ...
        for (ProductionOrder porder : productionList) {
            ...
            if (customerId.equalsIgnoreCase(porder.getCustomer().getCustomer_Id())
                    && (porder.getStatus().equalsIgnoreCase("Ordered")
    ...
    public String userViewCustomizedOrder(@RequestParam("customerName") String customerName, Model model)
            throws IOException {
        List<ProductionOrder> productionList = productionOrderService.getAllProductionOrders();
        ...
        for (ProductionOrder porder : productionList) {
            ...
            if (customerId.equalsIgnoreCase(porder.getCustomer().getCustomer_Id())
                ...
                model.addAttribute("customer", customer);
                model.addAttribute("productionOrder", porder);
                ProductMaterial productMaterial = productMaterialService.getProductMaterialByProduct_id(porder.getProduct().getProduct_Id());
                Diamond diamond = diamondService.getDiamondByProductId(porder.getProduct().getProduct_Id());
                Material material = materialService.getMaterialById(productMaterial.getId().getMaterial_Id());
                String cateUrl = imageService.getImgByCateogryID(String.valueOf(porder.getCategory().getCategory_Id()));
